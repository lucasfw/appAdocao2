...
public class MainActivity extends AppCompatActivity {
    ...
    EditText edtName, edtDescricao;
    Button btnEscolhaImagem, btnAdicionar, btnListar;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sqLiteHelper.queryData("CREATE TABLE IF NOT EXISTS ANIMAIS (Id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR, descricao VARCHAR, image BLOB)");

        btnEscolhaImagem.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void init(){
        ...
        btnEscolhaImagem = (Button) findViewById(R.id.btnEscolhaImagem);
